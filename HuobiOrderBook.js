...
var HuobiOrderBook = /** @class */ (function () {
    ...
    HuobiOrderBook.prototype.onCompleteHuobi = function (message) {
    ...
    HuobiOrderBook.prototype.onErrorHuobi = function (error) {
        console.error(error);
    };
    HuobiOrderBook.prototype.computeAverageBTCPrice = function () {
        return __awaiter(this, void 0, void 0, function () {
            var url, RequestBuilder, huobiBTCPrice;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        url = 'https://api.huobi.pro/market/depth?symbol=btcusdt&type=step0&depth=' + ordersLimit;
                        RequestBuilder = Okhttp.RequestBuilder;
                        return [4 /*yield*/, new RequestBuilder().GET(url).buildAndExecute().then(this.onCompleteHuobi).catch(this.onErrorHuobi)];
                    case 1:
                        huobiBTCPrice = _a.sent();
...
exports.HuobiOrderBook = HuobiOrderBook;
