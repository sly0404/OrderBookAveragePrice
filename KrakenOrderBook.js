...
var KrakenOrderBook = /** @class */ (function () {
    ...
    KrakenOrderBook.prototype.onCompleteKraken = function (message) {
    ...
    KrakenOrderBook.prototype.onErrorKraken = function (error) {
        console.error(error);
    };
    KrakenOrderBook.prototype.computeAverageBTCPrice = function () {
        return __awaiter(this, void 0, void 0, function () {
            var url, RequestBuilder, krakenBTCPrice;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        url = 'https://api.kraken.com/0/public/Depth?pair=XBTUSDT&count=' + ordersLimit;
                        RequestBuilder = Okhttp.RequestBuilder;
                        return [4 /*yield*/, new RequestBuilder().GET(url).buildAndExecute().then(this.onCompleteKraken).catch(this.onErrorKraken)];
                    case 1:
                        krakenBTCPrice = _a.sent();
